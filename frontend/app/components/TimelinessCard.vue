<template>
  ...
  >
    ...
    <div class="flex items-center gap-2 mb-3">
      <span :class="['px-3 py-1.5 text-xs font-medium rounded-full', categoryBadgeClass]">
        {{ categoryLabel }}
      </span>
      <span :class="['text-xs font-medium', decayRateColorClass]">
        {{ decayRateLabel }}
      </span>
    </div>
    ...
    >
      <div class="flex items-center gap-1 mb-2">
        <svg class="w-3 h-3 text-amber-700" fill="currentColor" viewBox="0 0 20 20">
          <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
        </svg>
        <span class="text-xs font-medium text-amber-800">时效性依赖</span>
      </div>
      <ul class="space-y-1">
        <li
